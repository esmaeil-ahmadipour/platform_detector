...
class PlatformDetectMatchedName extends StatelessWidget {
  ...
  const PlatformDetectMatchedName({Key? key, required this.ifMatch, required this.ifNotMatch, required this.platformName}) : super(key: key);
...
final PlatformName  platformName;
  ...
  Widget build(BuildContext context) {
    return PlatformDetector.platform.name == platformName ? ifMatch:ifNotMatch;
  }
}
