...
class PlatformDetectMatchedType extends StatelessWidget {
  ...
  const PlatformDetectMatchedType({Key? key, required this.ifMatch, required this.ifNotMatch, required this.platformType}) : super(key: key);
...
final PlatformType  platformType;
  ...
  Widget build(BuildContext context) {
    return PlatformDetector.platform.type == platformType ? ifMatch:ifNotMatch;
  }
}
